...
sub to_raw_X {
    ...
    $raw_X->remove_ModulePath(modules_dir() . "/extensions/$_") foreach 'nvidia97xx', 'nvidia96xx', 'nvidia71xx', 'nvidia173', 'nvidia304', 'nvidia340', 'nvidia-long-lived', 'nvidia-current';
